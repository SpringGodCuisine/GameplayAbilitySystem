...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attributes_HealthRegeneration, GetHealthRegenerationAttribute);
	TagsToAttributes.Add(GameplayTags.Attributes_ManaRegeneration, GetManaRegenerationAttribute);
...
void UAuraAttributeSet::Debuff(const FEffectProperties& Props)
{
	...
	InheritableOwnedTagsContainer.Added.AddTag(GameplayTags.DamageTypesToDebuffs[DamageType]); //添加标签
...
//通知能力系统我们正在复制一个值
/**
这是一个辅助宏，用于在 RepNotify（属性同步回调）函数中处理那些可能被客户端预测性修改的属性。
*/
