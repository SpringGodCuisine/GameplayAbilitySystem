...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_ManaRegeneration =  UGameplayTagsManager::Get().AddNativeGameplayTag(
